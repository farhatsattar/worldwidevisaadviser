  ...
  return (
    <section className="py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        ...
        <div className="mt-14 grid grid-cols-1 gap-8 md:mt-16 lg:grid-cols-[1.55fr_1fr] lg:items-stretch lg:gap-8">
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-[0_14px_40px_rgba(15,23,42,0.12)]">
            <div className="relative h-full min-h-[360px] w-full">
              <Image
                src="/images/image8.jpg"
                alt="Successful clients and immigration support"
                fill
